...
// import { insertFirst } from "../../../lib/dom/index.js";
...
export function renderSpinner(target = "body", data) {
  let item = createSpinner();
  let body = document.querySelector("body");
  body.insertAdjacentHTML("beforeend", item);
}

export function renderEmpty(target) {
  target.insertAdjacentHTML("beforeend", createEmpty());
}
